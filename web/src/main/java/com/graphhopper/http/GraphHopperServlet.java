...
public class GraphHopperServlet extends GHBaseServlet {
    ...
    public void doGet(HttpServletRequest httpReq, HttpServletResponse httpRes) throws ServletException, IOException {
        ...
        // TODO own settings
        String vehicleStr = getParam(httpReq, "vehicle", "chilango");
        String weighting = getParam(httpReq, "weighting", "chilango_weighting");
        String algoStr = getParam(httpReq, "algorithm", "chilango_dijkstra");
        String localeStr = getParam(httpReq, "locale", "es");
