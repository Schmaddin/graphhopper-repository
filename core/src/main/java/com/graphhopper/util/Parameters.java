...
public class Parameters {
	/*
	 * Parameters with an 'INIT' prefix are used as defaults and/or are
	 * configured at start.
	 */
	...
	public static final class Algorithms {
		...
		/**
		 * Unidirectional Dijkstra for Chilango
		 */
		public static final String DIJKSTRA_CHILANGO = "chilango_dijkstra";

		/**
		 * Bidirectional Dijkstra for Chilango
		 */
		public static final String DIJKSTRA_BI_CHILANGO = "chilango_dijkstrabi";
		/**
	...
	public static final class Routing {
		...
		/**
		 * true or false. If routes at via points should avoid u-turns. (not for
		 * CH) See related 'heading' parameter:
		...
		/**
		 * block road access via a point lat,lon or an area defined from a
		 * circle lat,lon,radius or a rectangular lat1,lon1,lat2,lon2
		 */
	...
	public static final class CH {
		...
		/**
		 * This property name in HintsMap configures at runtime if CH routing
		 * should be ignored.
		 */
		public static final String DISABLE = "ch.disable";
		/**
		 * This property name configures at start if the DISABLE parameter can
		 * have an effect.
		 */
		public static final String INIT_DISABLING_ALLOWED = ROUTING_INIT_PREFIX + "ch.disabling_allowed";
		/**
		 * The property name in HintsMap if heading should be used for CH
		 * regardless of the possible routing errors.
		 */
	...
	public static final class NON_CH {
		...
		/**
		 * Describes the maximum allowed distance between two consecutive
		 * waypoints of a non-CH request. Distance is in meter.
		 */
