...
public class TCPServerConnection implements ServerConnection {
	...
	public TCPServerConnection(EasyCrypt cryption, ServerMessageAuth auth) throws Exception {
		this(cryption, auth, hostname);
	}

	public TCPServerConnection(EasyCrypt cryption, ServerMessageAuth auth, String host) throws Exception {
		this(cryption, auth, host, Constants.SERVER_PORT_NUMBER_INTERN);
	}

	public TCPServerConnection(EasyCrypt cryption, ServerMessageAuth auth, String host, int port) throws Exception {
