 ...
 */
public class Path {
    protected static final AngleCalc AC = Helper.ANGLE_CALC;
	...
	public void setEdgeIds(GHIntArrayList edgeIds) {
		this.edgeIds = edgeIds;
	}

	public static AngleCalc getAc() {
		return AC;
	}

	public StopWatch getExtractSW() {
		return extractSW;
	}
     ...
     */
    protected static interface EdgeVisitor {
