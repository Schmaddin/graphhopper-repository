...
/**
 * A simple factory creating normal algorithms (RoutingAlgorithm) without
 * preparation.
 * <p>
 *
 * @author Peter Karich
...
public class RoutingAlgorithmFactorySimple implements RoutingAlgorithmFactory {
	...
	public RoutingAlgorithm createAlgo(Graph g, AlgorithmOptions opts) {
		...
		} else if (DIJKSTRA_CHILANGO.equalsIgnoreCase(algoStr)) {
			ra = new ChilangoDijkstra(g, opts.getWeighting(), opts.getTraversalMode());
		} else if (DIJKSTRA_BI_CHILANGO.equalsIgnoreCase(algoStr)) {
			ra = new ChilanogDijekstraBi(g, opts.getWeighting(), opts.getTraversalMode());
